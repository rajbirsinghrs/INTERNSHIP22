 ...
 */
public class CompanySocialLogin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            PreparedStatement ps=con.prepareStatement("select * from COMPANYLOGINS where email='"+email+"' and social_id='"+social_id+"'");
